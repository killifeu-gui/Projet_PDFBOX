@echo off
REM Script pour executer le client PDF de conversion et d'extraction de texte
...
echo ========================================
echo Execution du client PDF - Conversion/Texte
echo ========================================

"%JAVA_HOME%\bin\java" -cp %CLASSPATH% StartPdfClientConversionEtTexte %*
