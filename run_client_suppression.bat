@echo off
REM Client CORBA pour suppression de pages PDF
REM Usage: run_client_suppression pdf.pdf debut fin output.pdf
...
"%JAVA_HOME%\bin\java" -cp %CLASSPATH% CalculatriceClient.ClientSuppression %*